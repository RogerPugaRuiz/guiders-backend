...
export class IntegrationApiKey {
  ...
  public static fromPrimitives(params: {
    ...
    return new IntegrationApiKey(
      ...
      IntegrationApiKeyName.create(params.name),
      IntegrationApiKeyToken.create(params.tokenHash),
      params.tokenPrefix,
      IntegrationApiKeyEnvironment.create(params.environment),
      IntegrationApiKeyStatus.create(params.status),
      params.createdAt,
      params.lastUsedAt,
      params.revokedAt,
    );
