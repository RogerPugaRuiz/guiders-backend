...
/**
 * Value Object para la última actividad del comercial
...
export class CommercialLastActivity extends PrimitiveValueObject<Date> {
  ...
  public static now(): CommercialLastActivity {
    return new CommercialLastActivity(new Date());
  }
